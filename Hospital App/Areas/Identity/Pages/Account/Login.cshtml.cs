    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("UserRoles logged in.");
                    ...
                    else if (user.UserRole == "OfficeManager")
                    {
                        return RedirectToAction("Index", "OfficeManager");
                    }
                    else if (user.UserRole == "Nurse")
                    {
                ...
                {
                    _logger.LogWarning("UserRoles account locked out.");
